 ...
 */
public class RegularPolynomial {

    private static char default_char = 'x';

    private int[] coefficients;
    private char variableName = 0;
    public RegularPolynomial setVariableName(char variableName){ this.variableName = variableName; return  this; }

    public RegularPolynomial(int[] coefficients) {
        this.coefficients = coefficients.clone();
    }

    public RegularPolynomial(int[] coefficients, char variableName) {
        this(coefficients);
     ...
     * @return
     */
    public static RegularPolynomial fromRoots(int[] roots){
        // basic iterative algorithm
        RegularPolynomial total = fromSingleRoot(roots[0]);
    ...
    private static RegularPolynomial fromSingleRoot(int r){
        return new RegularPolynomial(new int[]{-r, 1});
    }
     ...
     * @return
     */
    public RegularPolynomial multiply(RegularPolynomial p){
        ...
        return new RegularPolynomial(prod);
