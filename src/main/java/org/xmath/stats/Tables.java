...
public final class Tables {
    ...
    /**
     * each index represent the degree of freedom and each secound index represent a critical value of :
     * [0]=0.90   [1]=0.95  [2]=0.975   [3]=0.99  [4]=0.995  [5]=0.999
     */
    private static final double[][] studentCriticalValue = {
            {3.078, 6.314, 2.706, 1.821, 3.657, 8.313},
            {1.886, 2.920, 4.303, 6.965, 9.925, 2.327},
            {1.638, 2.353, 3.182, 4.541, 5.841, 0.215},
    ...
    private static final double[] studentCriticalValueInfinity =
            {1.282, 1.645, 1.960, 2.326, 2.576, 3.090};


    public static final double studentLookup(int df, int criticalValueIndex){
        if (df > 99){
            return studentCriticalValueInfinity[criticalValueIndex];
        }
        return studentCriticalValue[df][criticalValueIndex];
    }
     ...
     * [0]=0.90   [1]=0.95  [2]=0.975   [3]=0.99  [4]=0.995  [5]=0.999
     */
    private static final double[] stdNormalCriticalValues =
            {1.281552, 1.644854, 1.96, 2.326348, 2.575829, 3.090232};

    public static double stdNormalLookup(int criticalValueIndex){
        return stdNormalCriticalValues[criticalValueIndex];
    }
    ...
    public static final double[] erfInverseCoeff =
            {1d/1d, 1d/3d, 7d/30d, 127d/630d, 4369d/22680d, 34807d/178200d, 20036983d/97297200d, 2280356863d/10216206000d};

    private static final double[] erfExtremeValues =
            {};
